...
const Contact = () => {
  return (
    ...
    >
        <p className='font-codeFont text-lg text-textViolet font-semibold flex items-center tracking-wide'>
            04. What&apos;s Next?
        </p>
        ...
        <a href="mailto:andrewduit@gmail.com">
            <button className='w-40 h-14 border border-textViolet mt-4 font-titleFont text-sm text-textViolet tracking-wider rounded-md hover:bg-hoverColor duration-300'> 
                Say Hello
            </button>
